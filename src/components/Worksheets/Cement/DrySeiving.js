...
function Compressivestrength() {
  ...
  return (
    ...
    <table className="mb-5 mt-5  cement-DrySieving-table">
       <tr >
      ...
      <table className="cement-DrySieving-table">
        <tr>
            <th rowspan="2">Sr.N0.</th>  <th rowspan="2"> Discription</th> 
             <th rowspan="2">Unit</th>  
             <th colspan="2">Test Number</th>  
        ...
        <tr>
            <td>1</td> <td>Weight of the Sample</td> <td>(a1)</td>  <td>g</td> <td></td> 
        </tr>
        <tr>
            <td>2</td> <td> Weight of Residue after Sieving</td> <td>A2</td> <td>g</td>  <td></td>
        </tr>
        <tr>
            <td>3</td> <td> Finance of Cement</td> <td>(A2/A1)X100</td> <td></td>  <td></td>
        </tr>
        <tr >
              <td colspan="6">Specified Limit:10%(Maximum)</td>
        </tr>
