...
function FinalSetting() {
  ...
  return (
    ...
    <table className="mb-5 mt-5 cement-finalsetting-table">
       <tr >
      ...
      <table className="cement-finalsetting-table">
        <tr>
            <th>Sr.N0.</th>  <th>Discription</th> 
             <th>Unit</th>  <th className="table3SecondTable">1</th>  
            <th className="table3SecondTable">2</th>  
        </tr>

        <tr>
            <td>1</td> <td>Normal Consistency(p)</td> <td>(%)</td>  <td></td> <td></td> 
        </tr>
        <tr>
            <td>2</td> <td> Time when Water is added to cement</td> <td></td> <td></td> <td></td> 
        </tr>
        <tr>
            <td>3</td> <td> Time of initial setting</td> <td></td> <td></td> <td></td> 
        </tr>
        <tr>
            <td>4</td> <td>Total Time taken for initial Setting Time</td> <td>Minutes</td> <td></td>  <td></td>
        </tr>
        <tr>
            <td>5</td> <td>Time of final Setting</td> <td></td> <td></td> <td></td>
        </tr>

        <tr>
            <td>6</td> <td>Total time taken for final setting time</td> <td>Minutes</td>  <td></td> <td></td>
        </tr>
