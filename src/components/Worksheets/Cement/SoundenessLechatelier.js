...
function FinalSetting() {
  ...
  return (
    ...
    <table className="mb-5 mt-5 cement-soundness-table">
           <tr >
        ...
        <table className="mb-5 cement-soundness-table">
            <tr>
          ...
          <table className="cement-soundness-table">
            <tr>
            ...
            <tr>
                <td>1</td> <td></td> <td></td> <td></td> <td rowspan="3"></td> 
            </tr>
            <tr>
